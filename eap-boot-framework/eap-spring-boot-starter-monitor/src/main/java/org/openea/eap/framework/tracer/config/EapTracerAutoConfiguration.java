...
import org.openea.eap.framework.tracer.core.aop.BizTraceAspect;
import org.openea.eap.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "eap.tracer", value = "enable", matchIfMissing = true)
public class EapTracerAutoConfiguration {
